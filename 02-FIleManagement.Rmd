...
Folders can typically be created in any operating system (mac or windows) by right clicking on the location and selecting ADD FOLDER. Folder names can be edited by left clicking on the folder to select it and then left clicking again (not a quick double click) to indicate you want to edit the name. 
