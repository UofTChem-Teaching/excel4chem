...
As an introduction to the chemistry we will in this activity, watch the video below, which describes some of the major chemical contributors to poor urban air quality. 

![**Figure 1.** A video describing the chemistry of air quality.  A transcript of the video (include chemical equations) can be accessed here.](<iframe width="560" height="315" src="https://play.library.utoronto.ca/embed/1f19e6aa27d9c50e551ee8848292fe7c" frameborder="0" allowfullscreen> iframe not supported </iframe>)
