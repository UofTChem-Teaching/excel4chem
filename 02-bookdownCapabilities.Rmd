...
We can also make it even easier to directly copy the table for smaller example datasets. Student's can just paste into excel and work along with the chapter. 
...
And lastly, we can readily embed videos directly on the webpage. Based on the video below, if CHNM135 students could have used their excel skills to close major business dealings in 1992...
